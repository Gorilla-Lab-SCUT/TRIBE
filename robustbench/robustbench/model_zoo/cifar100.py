...
from robustbench.model_zoo.architectures.modified_resnext import ModifiedHendrycks2020AugMixResNeXtNet
from robustbench.model_zoo.architectures.wide_resnet import WideResNet
from robustbench.model_zoo.architectures.modified_wide_resnet import ModifiedWideResNet
...
common_corruptions = OrderedDict([
    ...
    ('ModifiedHendrycks2020AugMix_ResNeXt', {
        'model': ModifiedHendrycks2020AugMixResNeXtNet,
        'gdrive_id': '1ocnHbvDdOBLvgNr6K7vEYL08hUdkD1Rv'
    }
    ),
    ('Addepalli2021Towards_PARN18', {
    ...
    ('ModifiedAddepalli2022Efficient_WRN_34_10', {
        'model':
        lambda: ModifiedWideResNet(depth=34, widen_factor=10, num_classes=100),
        'gdrive_id': '1-3c-iniqNfiwGoGPHC3nSostnG6J9fDt',
    })
])
